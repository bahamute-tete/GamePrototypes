Shader "Hidden/HDRP/WC_TerrainLit_BasemapGen"
{
    ...
    SubShader
    {
        ...
        Varyings Vert(uint vertexID : SV_VertexID)
        {
            ...
            output.texcoord.xy = output.positionCS.xy * .5 + .5;
            output.texcoord.y = 1 - output.texcoord.y;
            
            output.texcoord.zw = output.positionCS.xy * .5 + .5;
            output.texcoord.w = 1 - output.texcoord.w;
        ...
        Pass
        {
            ...
            #include "WCTerrainLit_Splatmap.hlsl"
