Shader "Custom/LiangZhu/MagicWater"
{
    Properties
    {
        [Header(Base)]
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half3 reflectionCol;
                    ...
                    float4 reflClip = mul(_PlanarReflectionVP, float4(IN.positionWS, 1.0));
                    float2 reflUV = (reflClip.xy / reflClip.w) * 0.5 + 0.5;
                    reflUV += nTS.xy * _PlanarDistortion;
