...
//
//   写入 controller 的 Sky A 字段：
//     skyTintA / skyExposureA / skyRotationA
// ====================================================================

public class SkyAMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            var input = (ScriptPlayable<SkyABehaviour>)playable.GetInput(i);
        ...
        // ====== 写入 controller 的 Sky A 字段 ======
        controller.skyTintA     = finalState.tint;
        controller.skyExposureA = Mathf.Clamp(finalState.exposure, 0f, 8f);
        controller.skyRotationA = Mathf.Clamp(finalState.rotation, -360f, 360f);
    }
}
