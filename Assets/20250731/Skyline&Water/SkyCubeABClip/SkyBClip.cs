...
// ====================================================================
//   Sky B Clip
//   定义一段时间内 Sky B 的 tint / exposure / rotation 从 startState 过渡到 endState
//   Curve 控制过渡速率
// ====================================================================

[System.Serializable]
[DisplayName("Sky B Clip")]
public class SkyBClip : PlayableAsset, ITimelineClipAsset
{
    ...
    {
        var playable = ScriptPlayable<SkyBBehaviour>.Create(graph);
