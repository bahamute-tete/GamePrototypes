...
// ====================================================================
//   Horizon Glow A Clip
//   定义一段时间内 A 组参数从 startState 过渡到 endState
//   Curve 控制过渡速率
// ====================================================================

[System.Serializable]
[DisplayName("Horizon Glow A Clip")]
public class HorizonGlowAClip : PlayableAsset, ITimelineClipAsset
{
    ...
    {
        var playable = ScriptPlayable<HorizonGlowABehaviour>.Create(graph);
