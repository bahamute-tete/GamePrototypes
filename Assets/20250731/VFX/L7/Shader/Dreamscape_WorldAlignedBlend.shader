...
Shader "Dreamscape_WorldAlignedBlend"
{
	Properties
	{
		...
		[KeywordEnum(NO_DISSOLVE,DISSOLVE_TEX,DISSOLVE_UP,DISSOLVE_DOWN)] _Dissolve("Dissolve",Float) = 0.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.vertexPos = float4(v.vertex.xyz,1);
						 ...
						 ) : SV_Target
			{
				...
				float4 mainColor = tex2D( _StoneTexture, uv_StoneTexture );
				...
				float4 lerpResult13 = lerp( mainColor , tex2D( _DirtTexture, uv_DirtTexture ) , clampResult41_g3);
				...
				float3 Emission = 0;
					...
					float2 uv_NoiseMap = IN.ase_texcoord8.xy * _NoiseMap_ST.xy + _NoiseMap_ST.zw;
				...
				float3 Translucency = 1;
					...
					clip(Alpha*mainColor.a - AlphaClipThreshold);
				#elif defined(_DISSOLVE_DISSOLVE_UP)
